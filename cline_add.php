...
{
    $command_line_result_arr[] = hzm_format_command_line("error", "Error 0005 when adding. Please check that the file '$object_table.php' file exists in module path '$module_path'");
    $nb_errors++;$command_finished = true;return;
}
...
if(!$objToShow)
{
    $command_line_result_arr[] = hzm_format_command_line("error", "Error 0001 add $object_class by code failed with message $message");
    $nb_errors++;$command_finished = true;return;
}
else
{
