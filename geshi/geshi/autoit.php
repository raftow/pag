...
$language_data = array(
    ...
    'KEYWORDS' => array(
        ...
        2 => array(
            ...
            '@AutoItVersion', '@AutoItX64', '@COM_EventObj', '@CommonFilbpracticeir',
            ...
            '@Favoritbpracticeir', '@GUI_CtrlHandle', '@GUI_CtrlId', '@GUI_DragFile',
            ...
            '@OSType', '@OSVersion', '@ProgramFilbpracticeir', '@ProgramsCommonDir',
        ...
        4 => array(
            ...
            'GDIPlus_ImageAttributbpracticeispose',
            ...
            'WinAPI_GetProcessWorkingDirectory', 'WinAPI_GetProfilbpracticeirectory',
