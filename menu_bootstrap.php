<?php
      ...
      {
                  $acc_list_html = "";
                  if($theme_title) $html .= "<li><a href='#'>$theme_title</a></li>\n";                
                  /*
        ...
        <ul class='$menu_class_ul settingsul'>\n";
                       foreach($menu[$theme_id][$subtheme_id] as $menu_id => $menu_item)
                       {
                               ...
                               if($menu_afw and $menu_mod and $menu_operation)
                               {
                                    $myObj = new $menu_afw();
                               ...
                               if($can_see_menu)
                               {
                                       ...
                                       $html .= "
                                                        <li>
                						<div class='progcard'>
                							<div class='$menu_class'><a $target_balise href='$menu_page' onclick='return true'>
