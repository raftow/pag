...
class PagAtableAfwStructure
{
	...
	public static $DB_STRUCTURE = array(
		...
		'id_module' => array(
			...
			'SHORTNAME' => 'module',
			'SEARCH-BY-ONE' => true,
			'DEPENDENT_OFME' => array(0 => 'id_sub_module',),
		...
		'is_enum' => array(
			...
			'SEARCH' => true,
			'CATEGORY' => 'FORMULA',
			'FIELD-FORMULA' => 'fnIsEnum(is_entity,is_lookup)',
			'FORMULA_MODULE' => 'pag',
			'FGROUP' => 'step1',
			'SEARCH-BY-ONE' => '',
			'DISPLAY' => true,
		...
		'origFieldList' => array(
			...
			'VIEW-ICON' => false,
			'BUTTONS' => true,
			'FGROUP' => 'origFieldList',
			'NO-LABEL' => true,
			'SEARCH-BY-ONE' => '',
			'DISPLAY' => true,
			'DISPLAY-UGROUPS' => '',
			'EDIT-UGROUPS' => '', /*'FGROUP_BEHAVIOR' => 'collapsed',*/
		),

		'auditFieldList' => array(
			'TYPE' => 'FK',
			'SHORTNAME' => 'audit_fields',
			'ANSWER' => 'afield',
			'ANSMODULE' => 'pag',
			'CATEGORY' => 'ITEMS',
			'ITEM' => 'atable_id',
			...
			'DELETE-ICON' => true,
			'BUTTONS' => true,
			'FGROUP' => 'auditFieldList',
			'FGROUP_BEHAVIOR' => 'collapsed',
			'NO-LABEL' => true,
			'SEARCH-BY-ONE' => '',
			'DISPLAY' => true,
			'DISPLAY-UGROUPS' => '',
