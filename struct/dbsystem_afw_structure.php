<?php 
        class PagDbsystemAfwStructure
        {
			...
			'dbsystem_name' => array('IMPORTANT' => 'IN',  'SHOW' => true,  'RETRIEVE' => false,  'EDIT' => true,  
				'TYPE' => 'TEXT',  'SEARCH-BY-ONE' => '',  'DISPLAY' => true,  'STEP' => 1,  
				'DISPLAY-UGROUPS' => '',  'EDIT-UGROUPS' => '', 
				),

			'dbsystem_code' => array('IMPORTANT' => 'IN',  'SHOW' => true,  'RETRIEVE' => false,  'EDIT' => true,  
				'TYPE' => 'TEXT',  'SEARCH-BY-ONE' => '',  'DISPLAY' => true,  'STEP' => 1,  
				'DISPLAY-UGROUPS' => '',  'EDIT-UGROUPS' => '', 
				),

		'syn' => array(
				'TYPE' => 'FK',  'ANSWER' => 'system_syntax',  
				'CATEGORY' => 'ITEMS',  'ITEM' => 'dbsystem_id',  
				'WHERE' => "", 
				 'SHOW' => true,  'ROLES' => '',  'FORMAT' => 'retrieve',  'EDIT' => false,  
				'DO-NOT-RETRIEVE-COLS' => array (
  0 => 'dbsystem_id',
),  'ANSMODULE' => 'pag',  'SEARCH-BY-ONE' => '',  'DISPLAY' => true,  'STEP' => 1,  
				'DISPLAY-UGROUPS' => '',  'EDIT-UGROUPS' => '', 
				),
