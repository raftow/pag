...
include "$file_dir_name/../pag/module_options.php";
     ...
     foreach($options_arr as $option_code => $option_props) 
     {
             if((!$option_props["admin"]) or ($objme->isAdmin()))
             {
               ...
               $out_scr .= "<div id='menu-item-control-options-$option_code' class='bf hzm-menu-item hzm3-col l3 m3 s12 $options_class'>
                                                <a class='hzm3-button hzm3-light-grey hzm3-block' href='main.php?Main_Page=toggle_option.php&option=$option_code&My_Module=pag' style='white-space:nowrap;text-decoration:none;margin-top:1px;margin-bottom:1px'>
