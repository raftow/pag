...
class AfieldRule extends AFWObject{
	...
	*/ public function __construct(){
        ...
        {
           $obj = new AfieldRule();
           if(!$afield_id) $obj->throwError("loadByMainIndex : afield_id is mandatory field");
           if(!$afield_rule_type_id) $obj->throwError("loadByMainIndex : afield_rule_type_id is mandatory field");
