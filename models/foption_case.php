	...
	*/ public function __construct(){
        ...
        public static function loadByMainIndex($foption_id, $foption_case,$create_obj_if_not_found=false)
        {
          if(strlen($foption_case)>24) return null;
           $obj = new FoptionCase();
           if(!$foption_id) $obj->throwError("foption_case::loadByMainIndex : foption_id is mandatory field");
           //if(!$foption_case) $obj->throwError("loadByMainIndex : foption_case is mandatory field");
