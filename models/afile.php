...
class Afile extends AFWObject{
	...
	public static $DATABASE		= ""; public static $MODULE		    = "pag"; public static $TABLE			= ""; public static $DB_STRUCTURE = null; /* = array(
		"id" => array("SHOW" => true, "RETRIEVE" => false, "EDIT" => true, "TYPE" => "PK"),
       		"original_name" => array("SHOW" => true, "RETRIEVE" => true, "EDIT" => true, "TYPE" => "TEXT", "UTF8"=>true, "SHORTNAME"=>"original", "SIZE"=>64, "READONLY"=>true, SEARCH => true, QSEARCH => true, QEDIT => false),
		"afile_name" => array("SHOW" => true, "RETRIEVE" => true, "EDIT" => true, "TYPE" => "TEXT", "UTF8"=>true, "SHORTNAME"=>"name", "SIZE"=>64, SEARCH => true, QSEARCH => true), // , "FORMAT"=>"ARABIC-TEXT"
                "afile_ext" => array("SHOW" => true, "RETRIEVE" => false, "EDIT" => true, "QEDIT" => false, "TYPE" => "TEXT", "UTF8"=>true, "SHORTNAME"=>"ext", "SIZE"=>5, "READONLY"=>true, SEARCH => true, QSEARCH => true, "NO-COTE"=>true),
		"doc_type_id" => array("IMPORTANT" => "IN", "SEARCH" => true, "SHOW" => true, "RETRIEVE" => true, "EDIT" => true, "QEDIT" => true, "SIZE" => 40, 
                                          "SEARCH-ADMIN" => true, "SHOW-ADMIN" => true, "EDIT-ADMIN" => true, 
                                          "UTF8" => false, "TYPE" => "FK", "ANSWER" => doc_type, "ANSMODULE" => "pag",
                                          WHERE=>"id in (§module_config_token_file_types§) and concat(',',valid_ext,',') like '%,§afile_ext§,%'", 
                                          "DEFAULT" => 0, SEARCH => true, QSEARCH => true),

                "afile_type" => array("SHOW" => true, "RETRIEVE" => true, "EDIT" => true, "QEDIT" => false, "TYPE" => "TEXT", "UTF8"=>true, "SHORTNAME"=>"type", "SIZE"=>16, "READONLY"=>true, SEARCH => true, QSEARCH => true),
                picture => array("RETRIEVE" => false, "EDIT" => true, "QEDIT" => false, "TYPE" => "YN", "DEFAULT"=>"N" , "READONLY"=>true),
                        small_picture => array("CATEGORY" => "FORMULA", "RETRIEVE" => false, "EDIT" => true, "QEDIT" => false, "TYPE" => "YN", "DEFAULT"=>"N" , "READONLY"=>true),
                        big_picture => array("CATEGORY" => "FORMULA", "RETRIEVE" => false, "EDIT" => true, "QEDIT" => false, "TYPE" => "YN", "DEFAULT"=>"N" , "READONLY"=>true),
                        embed => array("CATEGORY" => "FORMULA", "RETRIEVE" => false, "EDIT" => true, "QEDIT" => false, "TYPE" => "YN", "DEFAULT"=>"N" , "READONLY"=>true),
		"afile_size" => array("SHOW" => true, "RETRIEVE" => true, "EDIT" => true, "QEDIT" => false, "TYPE" => "INT", "SHORTNAME"=>"size", "READONLY"=>true),
                "afile_date" => array("TYPE" => "DATE", "CATEGORY" => "FORMULA",  "EDIT" => true, "QEDIT" => false, "READONLY"=>true, "SHOW" => true, "SEARCH" => false, "FORMAT" => "CONVERT_NASRANI_SIMPLE"),
                "afile_time" => array("TYPE" => "TIME", "CATEGORY" => "FORMULA",  "EDIT" => true, "QEDIT" => false, "READONLY"=>true, "SHOW" => true, "SEARCH" => false),
                "owner_id" => array(SEARCH => true, QSEARCH => true, "SHOW" => true, "RETRIEVE" => true, "EDIT" => true, "QEDIT" => true, "SIZE" => 40, 
                                    "SEARCH-ADMIN" => true, "SHOW-ADMIN" => true, "EDIT-ADMIN" => true, "UTF8" => false, "TYPE" => "FK", 
                                    "ANSWER" => auser, "ANSMODULE" => "ums", "DEFAULT" => 0, "DISTINCT-FOR-LIST"=>true, "READONLY"=>true),
		"stakeholder_id" => array("IMPORTANT" => "IN", "SEARCH" => true, "SHOW" => true, "RETRIEVE" => false, "QEDIT" => false, "EDIT" => true, "SIZE" => 40, "SEARCH-ADMIN" => true, 
                                          "SHOW-ADMIN" => true, "EDIT-ADMIN" => true, "UTF8" => false, "TYPE" => "FK", "ANSWER" => orgunit, "ANSMODULE" => "hrm", "DEFAULT" => 0, "READONLY"=>true),

                "preview" 	    => array("TYPE" => "TEXT", "CATEGORY" => "FORMULA", "SHOW"=>true, "RETRIEVE"=>false, "EDIT-HIDDEN" => true, "EDIT" => true, "QEDIT" => false, "READONLY"=>true, 
                                              "SIZE" => 128, RO_DIV_CLASS=>"preview_file" , EAGER=>false),

                "file_path" 	    => array("TYPE" => "TEXT", "CATEGORY" => "FORMULA", "SIZE" => 128, EAGER=>false),
                                              

                "pic_view" 	    => array("TYPE" => "TEXT", "CATEGORY" => "FORMULA", "SHOW"=>true, "RETRIEVE"=>true, "EDIT-HIDDEN" => true, "EDIT" => true, "QEDIT" => true, "READONLY"=>true, 
                                              "SIZE" => 128, RO_DIV_CLASS=>"preview_file"),
                                          
                "download" 	    => array("TYPE" => "TEXT", "CATEGORY" => "FORMULA", "SHOW"=>true, "RETRIEVE"=>true, "EDIT" => true, "QEDIT" => false, "READONLY"=>true, "RO_DIV_CLASS"=>"empty_div"),
                "download_light" 	    => array("TYPE" => "TEXT", "CATEGORY" => "FORMULA", "SHOW"=>true, "RETRIEVE"=>true, "EDIT" => true, "QEDIT" => false, "READONLY"=>true, "RO_DIV_CLASS"=>"empty_div"),
                
                "is_ok" 	    => array("TYPE" => "TEXT", "CATEGORY" => "FORMULA", "SHOW" => true, "RETRIEVE"=>true, "EDIT" => false, "QEDIT" => false, "READONLY"=>true, "NO-ERROR-CHECK"=>true),
		...
		"avail" => array("SHOW" => true, "RETRIEVE" => false, "EDIT" => true, "QEDIT" => true, "TYPE" => "YN", "DEFAULT"=>"Y" ),
	...
	*/ public function __construct(){
		parent::__construct("afile","id","pag");
...
zoomWindowOffety:-200
        ...
        public function showMySelf($style="")
        {
           global $lang;
               ...
               $span_edit = "<span><a href='main.php?Main_Page=afw_mode_display.php&cl=Afile&currmod=pag&id=$my_id'>$display</a></span><br>";
        ...
        public function getExcelData($row_num_start=-1, $row_num_end=-1, $caller="not-defined")
        {
             ...
             $afile_ext = $this->getVal("afile_ext");
              ...
              if(($doc_type_id==14) and (in_array($afile_ext,$xls_ext_arr)))
              {
                     ...
                     if(!file_exists($file_path))
                     {
                            $this->throwError("File not found : $file_path");
                     }
              ...
              {
                     $this->throwError("getExcelData method can not work on non excel or non importable files, your file extension : $afile_ext, doc type = ".$this->het("doc_type_id"));
              }            
        }
