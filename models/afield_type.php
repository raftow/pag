...
class AfieldType extends AFWObject
{
        ...
        public function getAfwType()
        {
                ...
                elseif ($this->getId() == AfwUmsPagHelper::$afield_type_Gdat)
                        return 'GDAT';
                elseif ($this->getId() == AfwUmsPagHelper::$afield_type_smallint)
                        return 'SMLINT';
                elseif ($this->getId() == AfwUmsPagHelper::$afield_type_bigint)
                        return 'BIGINT';
                elseif ($this->getId() == AfwUmsPagHelper::$afield_type_mediumint)
                        return 'INT';
        ...
        {
                if ($this->getId() == AfwUmsPagHelper::$afield_type_Gdat)
                        return 'Gregorian YYYY-MM-DD  تاريخ نصراني';
                if ($this->getId() == AfwUmsPagHelper::$afield_type_date)
                        return 'hijri YYYYmmDD  تاريخ هجري';
                if ($this->getId() == AfwUmsPagHelper::$afield_type_yn)
                        return 'Y/N   تعني نعم/لا';
